...
print >> o, """
'''Magic Lantern 0.2 for Canon 60D, Firmware 1.0.9'''
...
o = open("userguide.rst", "w")
print >> o, """Magic Lantern 0.2 for Canon 60D, Firmware 1.0.9 -- User's Guide
===========================================================================
...
os.system("rst2latex userguide.rst --output-encoding=utf8 --template=ug-template.tex --table-style booktabs > UserGuide.tex")
...
os.system("rst2latex INSTALL.rst --output-encoding=utf8 --template=ins-template.tex > INSTALL.tex")
