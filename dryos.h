...
struct mvr_config
{
	...
	uint32_t		hd_60fps_gop_opt_0;		// 0x164, 68d0
	uint32_t		hd_60fps_gop_opt_1;		// 0x168, 68d4
	uint32_t		hd_60fps_gop_opt_2;		// 0x16c, 68d8
	uint32_t		hd_60fps_gop_opt_3;		// 0x170, 68dc
	uint32_t		hd_60fps_gop_opt_4;		// 0x174, 68e0
	uint32_t		hd_50fps_gop_opt_0;		// 0x178, 68e4
	uint32_t		hd_50fps_gop_opt_1;		// 0x17c, 68e8
	uint32_t		hd_50fps_gop_opt_2;		// 0x180, 68ec
	uint32_t		hd_50fps_gop_opt_3;		// 0x184, 68f0
	uint32_t		hd_50fps_gop_opt_4;		// 0x188, 68f4
	uint32_t		vga_60fps_gop_opt_0;	// 0x18c, 68f8
	uint32_t		vga_60fps_gop_opt_1;	// 0x190, 68fc
	uint32_t		vga_60fps_gop_opt_2;	// 0x194, 6900
	uint32_t		vga_60fps_gop_opt_3;	// 0x198, 6904
	uint32_t		vga_60fps_gop_opt_4;	// 0x19c, 6908
	uint32_t		vga_50fps_gop_opt_0;	// 0x1a0, 690c
	uint32_t		vga_50fps_gop_opt_1;	// 0x1a4, 6910
	uint32_t		vga_50fps_gop_opt_2;	// 0x1a8, 6914
	uint32_t		vga_50fps_gop_opt_3;	// 0x1ac, 6918
	uint32_t		vga_50fps_gop_opt_4;	// 0x1b0, 691c
